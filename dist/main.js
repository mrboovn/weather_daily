...
async function initialize(long, lat) { // Initializes data objects
  ...
  let link = 'https://api.openweathermap.org/data/2.5/onecall?lat=' + (lat).toFixed(5) + '&lon=' + long.toFixed(5) + '&exclude=hourly,minutely&appid=4f66373191a6f6e6a6f2a099638fa071&units=imperial';
